...
export default function ExamineeProfile({
  params
}: {
  params: { id: string }
}) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-gray-500">
                    জন্ম নিবন্ধন / জাতীয় পরিচয় পত্র নাম্বার
                  </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            ...
            <div className="mt-4 sm:mt-0">
              ...
              >
                <option value="কেন্দ্রীয়_পরীক্ষা_১৪৪৬_হি">
                  কেন্দ্রীয় পরীক্ষা ১৪৪৬ হি.
                </option>
                <option value="অর্ধ-বার্ষিক_পরীক্ষা_১৪৪৬_হি">
                  অর্ধ-বার্ষিক পরীক্ষা ১৪৪৬ হি.
                </option>
                <option value="বার্ষিক_পরীক্ষা_১৪৪৫_হি">
                  বার্ষিক পরীক্ষা ১৪৪৫ হি.
                </option>
              </select>
            </div>
          </div>
          ...
          <div className="mb-6 bg-[#52b788]/5 rounded-lg p-4 border border-[#52b788]/20">
            <div>
              <h3 className="font-medium text-[#52b788]">
                কেন্দ্রীয় পরীক্ষা ১৪৪৬ হি.
              </h3>
              <p className="text-sm text-gray-600 mt-1">
                মুতাওয়াস্সিতাহ প্রথম বর্ষ
              </p>
            </div>
          </div>
                  ...
                  return results.map((subject, index) => {
                    ...
                    return (
                      <tr key={index} className="border-b hover:bg-gray-50">
                        ...
                        <td
                          className={`border px-4 py-3 text-center font-medium ${gradeColor}`}
                        >
                          {grade}
                        </td>
                      </tr>
                ...
                <tr className="bg-gray-50 font-medium">
                  ...
                  <td className="border px-4 py-3 text-center">
                    {(() => {
                      const examData = {
                        কেন্দ্রীয়_পরীক্ষা_১৪৪৬_হি: [
                          85, 78, 82, 90, 75, 88, 70, 92, 86
                        ],
                        'অর্ধ-বার্ষিক_পরীক্ষা_১৪৪৬_হি': [
                          88, 92, 85, 78, 90, 82, 88, 75, 80
                        ],
                        বার্ষিক_পরীক্ষা_১৪৪৫_হি: [
                          95, 88, 82, 85, 90, 78, 85, 92, 84
                        ]
                      }
                      const currentExam = 'কেন্দ্রীয়_পরীক্ষা_১৪৪৬_হি' // This would come from state
                  ...
                  <td className="border px-4 py-3 text-center text-[#52b788]">
                    ممتاز
                  </td>
                </tr>
              </tbody>
