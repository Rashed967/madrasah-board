...
export function MadrasahListHeaderSection({
  onPrintList,
  onPrintAddresses
}: MadrasahListHeaderSectionProps) {
  return (
    <div className="flex justify-between items-center mb-6">
      <div>
        <h1 className="text-sm md:text-base lg:text-lg font-bold text-gray-800">
          মাদরাসা তালিকা
        </h1>
      ...
      <div className="flex gap-2">
        ...
        >
          ...
          <span className="hidden md:inline ">মাদরাসার</span> তালিকা{' '}
