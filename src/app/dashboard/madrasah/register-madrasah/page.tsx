        ...
        <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 rounded-lg shadow">
          ...
          <div className="pt-5">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#52b788] hover:bg-[#40916c] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#52b788] disabled:bg-gray-400"
            >
