    ...
    <div className="m-4 md:m-8 lg:m-10 xl:m-12">
      ...
      <div className="mb-6 px-6 text-center">
        ...
        <p className="text-sm md:text-base text-gray-600 mt-1">
          নতুন মাদরাসা নিবন্ধনের জন্য তথ্য পূরণ করুন
        </p>
      </div>

      <form
        onSubmit={handleSubmit}
        className="space-y-0 md:space-y-4 bg-white/80 rounded-lg shadow-md p-4 md:p-6 lg:p-8 xl:p-10"
      >
        <MadrasahNameAndBio
          formData={formData}
        ...
        <MadrasahBasicInfo
          formData={{
            madrasah_information: {
              ...
              highestMarhala: formData.madrasah_information
                .highestMarhala as string
            }
          }}
          handleChange={handleChange}
          errors={errors}
