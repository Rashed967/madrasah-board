...
export default function ChairmanInfo({ formData, onChange, errors }: Props) {
  return (
    <div className="p-6 mb-6">
      <h2 className="text-base md:text-xl lg:text-2xl font-semibold mb-6">
        সভাপতি/মুতাওয়াল্লীর তথ্য
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange('chairman_mutawalli.name', e.target.value)
            }
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange('chairman_mutawalli.nidNumber', e.target.value)
            }
            className={`mt-1 block w-full rounded-md border ${
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange('chairman_mutawalli.contactNo', e.target.value)
            }
            className={`mt-1 block w-full rounded-md border ${
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange(
                'chairman_mutawalli.highestEducationalQualification',
                e.target.value
              )
            }
            className={`mt-1 block w-full rounded-md border ${
