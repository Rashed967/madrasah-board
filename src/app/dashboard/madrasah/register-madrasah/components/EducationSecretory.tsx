...
interface EducationSecretoryProps {
  formData: {
    educational_secretory: Pick<
      IEducationalSecretary,
      'name' | 'contactNo' | 'nidNumber' | 'highestEducationalQualification'
    >
  }
 ...
 */
const EducationSecretory: React.FC<EducationSecretoryProps> = ({
  formData,
  handleChange,
  errors
}) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('educational_secretory.name', e.target.value)
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('educational_secretory.nidNumber', e.target.value)
              }
              className={`mt-1 block w-full rounded-md border ${
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('educational_secretory.contactNo', e.target.value)
              }
              className={`mt-1 block w-full rounded-md border ${
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange(
                  'educational_secretory.highestEducationalQualification',
                  e.target.value
                )
              }
              className={`mt-1 block w-full rounded-md border ${
