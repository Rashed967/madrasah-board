 ...
 */
const MutawalliInfo: React.FC<MutawalliInfoProps> = ({
  formData,
  handleChange,
  errors
}) => {
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('chairman_mutawalli.name', e.target.value)
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleChange('chairman_mutawalli.designation', e.target.value)
              }
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm md:text-base text-gray-700 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('chairman_mutawalli.nidNumber', e.target.value)
              }
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm md:text-base text-gray-700 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('chairman_mutawalli.contactNo', e.target.value)
              }
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm md:text-base text-gray-700 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
            />
          </div>
