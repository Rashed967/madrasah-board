 ...
 */
export default function MuhtamimInfo({
  formData,
  handleChange,
  errors
}: Props) {
...
<div className="col-span-3">
        <label className="block text-gray-700 text-sm md:text-base font-bold mb-2">
          মুহতামিমের সংক্ষিপ্ত বায়ো লিখুন (শিক্ষাগত যোগ্যতা, ফারেগের সাল, মাদ্রাসা)<span className="text-red-500">* </span>
        </label>
        <textarea
          ...
          className={`mt-1 block w-full rounded-md border h-24 ${
            errors.muhtamim ? 'border-red-500' : 'border-gray-300'
          } px-3 py-2 text-xs md:text-base text-gray-700 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500`}
          placeholder="মুহতামিমের সংক্ষিপ্ত বায়ো লিখুন"
        />
