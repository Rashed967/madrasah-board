 ...
 */
export default function MadrasahNameAndBio({
  formData,
  handleChange,
  errors
}: Props) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleChange('madrasahNames.bengaliName', e.target.value)
            }
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleChange('madrasahNames.arabicName', e.target.value)
            }
            className={`mt-1 block w-full rounded-md border ${
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleChange('madrasahNames.englishName', e.target.value)
            }
            className={`mt-1 block w-full rounded-md border ${
