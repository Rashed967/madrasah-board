...
export default function EducationalSecretaryInfo({
  formData,
  onChange,
  errors
}: Props) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange('educational_secretory.name', e.target.value)
            }
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange('educational_secretory.nidNumber', e.target.value)
            }
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange('educational_secretory.contactNo', e.target.value)
            }
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
