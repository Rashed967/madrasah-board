    ...
    <div className="mx-4 mt-16 mb-8 px-2 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
        <div className="space-y-4 bg-white p-6 rounded-lg shadow-md">
          ...
          <InfoCard
            icon={MdPhone}
            label="যোগাযোগ"
            value={`${contactNo1}${contactNo2 ? `, ${contactNo2}` : ''}`}
          />
        </div>
        <div className="space-y-4 bg-white p-6 rounded-lg shadow-md">
          <InfoCard
            ...
            value={
              address
                ? `${address.holdingNumber}, ${address.village}, ${address.postOffice}, ${address.subDistrict_policeStation}, ${address.district}, ${address.division}`
                : undefined
            }
          />
          <InfoCard
            icon={MdDomain}
            label="মাদ্রাসার ধরণ"
            value={madrasah_information?.madrasahType}
          />
          <InfoCard
            icon={MdStar}
            label="সর্বোচ্চ মারহালা"
            value={
              typeof madrasah_information?.highestMarhala === 'object'
                ? madrasah_information?.highestMarhala.name?.bengaliName
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <PersonCard
            title="চেয়ারম্যান/মুতাওয়াল্লি"
            person={chairman_mutawalli}
          />
