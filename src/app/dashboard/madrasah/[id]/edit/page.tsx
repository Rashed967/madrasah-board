...
import {
  ...
  TCourierAddress,
  TMadrasahType,
  TMutawalliDesignation
} from '@/features/madrasah/interfaces'
import {
  updateMadrasahBasicInfo,
  getMadrasahById,
  updateMadrasahInformation
} from '@/services/madrasahService'
import { updateMadrasahAddress } from '@/services/addressService'
import {
  updateMuhtamim,
  updateChairmanMutawalli,
  updateEducationalSecretary
...
export default function EditMadrasahPage({
        ...
        if (response.success && response.data) {
          const madrasahData: IMadrasah = {
            ...
            muhtamim: {
              ...
              highestEducationalQualification:
                response.data.muhtamim?.highestEducationalQualification || '',
            ...
            chairman_mutawalli: {
              ...
              designation:
                response.data.chairman_mutawalli?.designation ||
                ('' as TMutawalliDesignation),
            ...
            educational_secretory: {
              ...
              highestEducationalQualification:
                response.data.educational_secretory
                  ?.highestEducationalQualification || '',
  ...
  const handleAddressUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const addressData: IMadrasahAddress = {
        ...
        courierAddress:
          formData.address.courierAddress || ('' as TCourierAddress)
      }

      const response = await updateMadrasahAddress(
        formData.address._id.toString(),
        addressData
      )
      ...
      if (response.success) {
        ...
        setStatusDialog({
          ...
          title: 'ত্রুটি!',
          message:
            response.message || 'মাদরাসার ঠিকানা আপডেট করতে সমস্যা হয়েছে'
        })
      }
    } catch (error: any) {
      setStatusDialog({
  ...
  const handleInformationUpdate = async (
    ...
    const validationErrors = globalValidateRequest(
      madrasahInfoSchemas.updateMadrasahInfoSchema,
      formData
    )
    if (Object.keys(validationErrors).length > 0) {
      setErrors(validationErrors)
    ...
    try {
      ...
      const response = await updateMadrasahInformation(
        formData.madrasah_information._id.toString(),
        madrasahInfo
      )
  ...
  const handleMuhtamimUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const validationErrors = globalValidateRequest(
      staffSchemas.updateMuhtamimSchema,
      formData
    )
    if (Object.keys(validationErrors).length > 0) {
      setErrors(validationErrors)
    ...
    try {
      ...
      const muhtamimInfo = {
        ...
        highestEducationalQualification:
          formData.muhtamim.highestEducationalQualification
      }
      const response = await updateMuhtamim(
        formData.muhtamim._id.toString(),
        muhtamimInfo
      )
      ...
      if (response.success) {
        ...
        setStatusDialog({
          ...
          title: 'ত্রুটি!',
          message:
            response.message || 'মুহতামিমের তথ্য আপডেট করতে সমস্যা হয়েছে'
        })
      }
    } catch (error: any) {
      setStatusDialog({
  ...
  const handleMutawalliUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const validationErrors = globalValidateRequest(
      staffSchemas.updateMutawalliSchema,
      formData
    )
    if (Object.keys(validationErrors).length > 0) {
      setErrors(validationErrors)
    ...
    try {
      ...
      const response = await updateChairmanMutawalli(
        formData.chairman_mutawalli._id.toString(),
        mutawalliInfo
      )
      ...
      if (response.success) {
        ...
        setStatusDialog({
          ...
          message:
            response.message ||
            'চেয়ারম্যান/মুতাওয়াল্লির তথ্য আপডেট করতে সমস্যা হয়েছে'
        })
      }
    } catch (error: any) {
      setStatusDialog({
  ...
  const handleSecretaryUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const validationErrors = globalValidateRequest(
      staffSchemas.updateEducationalSecretarySchema,
      formData
    )
    if (Object.keys(validationErrors).length > 0) {
      setErrors(validationErrors)
    ...
    try {
      ...
      const secretaryInfo = {
        ...
        highestEducationalQualification:
          formData.educational_secretory.highestEducationalQualification
      }

      const response = await updateEducationalSecretary(
        formData.educational_secretory._id.toString(),
        secretaryInfo
      )
      ...
      if (response.success) {
        ...
        setStatusDialog({
          ...
          title: 'ত্রুটি!',
          message:
            response.message || 'শিক্ষা সচিবের তথ্য আপডেট করতে সমস্যা হয়েছে'
        })
      }
    } catch (error: any) {
      setStatusDialog({
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 ">
        <div className="flex flex-col space-y-6 ">
          ...
          <div className="flex flex-col space-y-4">
            <EditSectionTabs activeTab={activeTab} onTabChange={setActiveTab} />
