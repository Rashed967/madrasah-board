...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        {
          name: 'পরীক্ষা ক্রিয়েট',
          href: '/dashboard/exam/create-exam',
          icon: MdAdd
        },
        {
          name: 'সকল পরীক্ষা',
          href: '/dashboard/exam/all-exam',
    ...
    },
    {
      ...
      submenu: [
        {
          name: 'নতুন মারকায যুক্ত করুন',
          href: '/dashboard/markaz/add-markaz',
          icon: MdAdd
        },
        {
          name: 'সকল মারকায',
          href: '/dashboard/markaz/all-markaz',
          icon: MdList
        }
      ]
    },
    { name: 'নেগরন ও মুমতাহিন', href: '/#mumtahin', icon: MdPerson,
      submenu: [
        {
          name: 'মুমতাহিন যুক্ত করুন',
          href: '/dashboard/mumtahin/add-mumtahin',
          icon: MdAdd
        },
        {
          name: 'সকল মুমতাহিন',
          href: '/dashboard/mumtahin/all-mumtahins',
          icon: MdList
        }
      ]
     },
