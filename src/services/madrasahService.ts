...
export async function registerMadrasah(formData: any) {
  ...
  const response = await post<IMadrasah>(
    '/madrasah/create-by-admin',
    registrationData
  )
...
const selectedFields =
  '-chairman_mutawalli,-educational_secretory,-madrasahResult,-user,-registrationToken,-registrationTokenExpiry,-description,-createdAt,-updatedAt,-updatedAt,-userAccountCreated'
const sortOrder = 'asc'
const sortBy = 'code'
export const getAllMadrasahs = async (
  ...
  try {
    const response = await get<IMadrasah[]>(
      `/madrasah?select=${selectedFields}&${queryParams}`
    )
    return {
...
export const getMadrasahById = async (
  ...
  try {
    ...
    return {
      ...
      message:
        error?.response?.data?.message ||
        'মাদরাসার তথ্য লোড করতে সমস্যা হয়েছে',
      data: null
    }
  }
}
...
export const createMadrasah = async (
  data: any
): Promise<ApiResponse<IMadrasah>> => {
  try {
    ...
    return {
      success: false as const,
      message:
        error?.response?.data?.message || 'মাদরাসা তৈরি করতে সমস্যা হয়েছে',
      data: null
    }
  }
}
...
export const updateMadrasahBasicInfo = async (
  ...
  try {
    ...
    return {
      ...
      message:
        error?.response?.data?.message ||
        'মাদরাসার তথ্য আপডেট করতে সমস্যা হয়েছে',
      data: null
    }
  }
}
...
export const updateMadrasahAddress = async (
  ...
  try {
    ...
    return {
      ...
      message:
        error?.response?.data?.message ||
        'মাদরাসার ঠিকানা আপডেট করতে সমস্যা হয়েছে',
      data: null
    }
  }
}

export const updateMadrasahMuhtamim = async (
  id: string,
  data: any
): Promise<ApiResponse<IMadrasah>> => {
  try {
    ...
    return {
      ...
      message:
        error?.response?.data?.message ||
        'মাদরাসার মুহতামিম আপডেট করতে সমস্যা হয়েছে',
      data: null
    }
  }
}

export const updateMadrasahChairmanMutawalli = async (
  id: string,
  data: any
): Promise<ApiResponse<IMadrasah>> => {
  try {
    const response = await patch<IMadrasah>(
      `/madrasah/${id}/chairman-mutawalli`,
      data
    )
    return {
      success: true as const,
    ...
    return {
      ...
      message:
        error?.response?.data?.message ||
        'মাদরাসার চেয়ারম্যান মুতাওয়াল্লি আপডেট করতে সমস্যা হয়েছে',
      data: null
    }
  }
}

export const updateMadrasahEducationalSecretary = async (
  id: string,
  data: any
): Promise<ApiResponse<IMadrasah>> => {
  try {
    const response = await patch<IMadrasah>(
      `/madrasah/${id}/educational-secretary`,
      data
    )
    return {
      success: true as const,
    ...
    return {
      ...
      message:
        error?.response?.data?.message ||
        'মাদরাসার শিক্ষা সচিব আপডেট করতে সমস্যা হয়েছে',
      data: null
    }
  }
}
...
export const getAllMadrasahsBySearchTerm = async (
  page: number = 1,
  limit: number = 10
): Promise<ApiResponse<IMadrasah[]>> => {
  try {
    const response = await get<IMadrasah[]>(
      `/madrasah?page=${page}&limit=${limit}`
    )
    return {
      success: true as const,
      message: response.message,
...
export const deleteMadrasah = async (id: string) => {
  try {
    ...
    return {
      success: false as const,
      message:
        error?.response?.data?.message || 'মাদরাসা ডিলিট করতে সমস্যা হয়েছে',
      data: null
    }
  }
}
